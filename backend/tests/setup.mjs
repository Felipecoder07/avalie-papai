...
for (const name of Object.keys(process.env)) {
  if (/^(EMAIL_|MERCADO_?PAGO|MP_|GOOGLE_|SUPABASE_|SECRETS_|LISTEN_HOST|ENABLE_PAYMENT_SIMULATION|FRONTEND_URL|APP_URL|CORS_ALLOWED_ORIGINS|TRUST_PROXY)/.test(name)) delete process.env[name];
}
